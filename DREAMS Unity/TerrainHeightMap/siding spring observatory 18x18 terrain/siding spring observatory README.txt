...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=siding+spring+observatory&box=149.155165,-31.196135,148.965810,-31.357831
...
-----------
  ...
  * siding spring observatory Height Map (ASTER 30m).png
  ...
  * siding spring observatory Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * siding spring observatory Height Map (SRTM3 v4.1).png
  ...
  * siding spring observatory Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 422m (actual) is equal to 40m in
